  ...
  <div v-if="showModel.showSearchProductModel">
    <group v-for="productItem in productsData.getProducts.list">
      <div class="linkProductToQRCodeSearch-list">
        ...
        <div class="linkProductToQRCodeSearch-button">
...
#linkProductToQRCodeSearch .linkProductToQRCodeSearch-list .linkProductToQRCodeSearch-button button.weui_btn.weui_btn_default {
  background: #fff;
  border: 0;
  font-size: 4.7vw;
  color: #21c36d;
